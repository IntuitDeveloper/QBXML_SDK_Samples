...
public:
  ...
  // Format XML with line breaks and indents.
  static string FormatXML( const string& strXML );
  ...
  void CreateSubscriptionXMLTrailer();    // Create XML Trailer for Subscription requests
  void CreateSubscriptionXMLHeader();     // Create XML Header for Subscription requests
