...
This sample is a simple VB.NET desktop application that adds data extensions into QuickBooks, and allows the user to modify the data extension value using qbXML 
