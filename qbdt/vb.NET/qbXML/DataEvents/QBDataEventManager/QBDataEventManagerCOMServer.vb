...
Friend NotInheritable Class QBDataEventManagerCOMServer

    Private Sub New()
    End Sub

    Private Shared _instance As QBDataEventManagerCOMServer = New QBDataEventManagerCOMServer
    Public Shared ReadOnly Property Instance() As QBDataEventManagerCOMServer
        Get
            Return QBDataEventManagerCOMServer._instance
        End Get
    End Property
    ...
    Private Sub PreMessageLoop()
        ...
        Dim clsid As New Guid(QBEventHandler.ClassId)


        Dim hResult As Integer = ComInit.CoRegisterClassObject(
        clsid, New QBEventHandlerClassFactory, CLSCTX.LOCAL_SERVER,
        ...
        Me.timer = New Timer(
        New TimerCallback(AddressOf QBDataEventManagerCOMServer.GarbageCollect), Nothing,
        6000, 6000)
