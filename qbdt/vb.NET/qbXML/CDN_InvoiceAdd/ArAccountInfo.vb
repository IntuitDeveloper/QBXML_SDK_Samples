...
Module ArAccountInfo
	...
	Function GetArAccountList() As Object
        ...
        requestXML = "<?xml version=""1.0"" ?>" & "<?qbxml version=""CA2.0""?>" & "<QBXML><QBXMLMsgsRq onError=""continueOnError"">" & "<AccountQueryRq requestID=""1"">" & "<AccountType>AccountsReceivable</AccountType>" & "</AccountQueryRq>" & "</QBXMLMsgsRq></QBXML>"
