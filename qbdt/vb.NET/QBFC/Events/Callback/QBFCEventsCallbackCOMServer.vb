...
Friend NotInheritable Class QBFCEventsCallbackCOMServer

    Private Sub New()
    End Sub

    Private Shared _instance As QBFCEventsCallbackCOMServer = New QBFCEventsCallbackCOMServer
    Public Shared ReadOnly Property Instance() As QBFCEventsCallbackCOMServer
        Get
            Return QBFCEventsCallbackCOMServer._instance
        End Get
    End Property
    ...
    Private Sub PreMessageLoop()
        ...
        Dim clsid As New Guid(QBFCEventsCallbackClass.ClassId)


        Dim hResult As Integer = ComInit.CoRegisterClassObject(
        clsid, New QBFCEventsCallbackClassFactory, CLSCTX.LOCAL_SERVER,
        ...
        Me.timer = New Timer(
        New TimerCallback(AddressOf QBFCEventsCallbackCOMServer.GarbageCollect), Nothing,
        6000, 6000)
