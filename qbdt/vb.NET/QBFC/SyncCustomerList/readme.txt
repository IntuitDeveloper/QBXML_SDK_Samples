...
Before running SyncCustomerList.exe, make sure that .NET runtime is installed on the machine, 
and QuickBooks is running with a company opened. 

Building the sample
------------------
Please install latest QBSDK.
Open SyncCustomerList.sln in Microsoft Visual Studio .NET and build the solution.
