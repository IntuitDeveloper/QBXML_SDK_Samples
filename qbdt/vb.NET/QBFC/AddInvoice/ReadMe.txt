AddInvoice is VB sample code which shows how the same invoice can be added using qbXML
built with the MSXML4 DOM parser and QBFC.  It is intended to be used with the sample product
