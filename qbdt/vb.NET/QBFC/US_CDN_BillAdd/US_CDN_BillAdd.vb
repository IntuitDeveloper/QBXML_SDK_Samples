...
Friend Class BillAdd
	...
	'
	Const appName As String = "IDN US-Canada Bill Add Sample"
	'
...
gotmsgset: 
	...
	Public Function GetLatestMsgSetRequest(ByRef SessionManager As QBFC15Lib.QBSessionManager) As QBFC15Lib.IMsgSetRequest
		...
		strVersions = VB6.CopyArray(SessionManager.QBXMLVersionsForSession)
		If InStr(1, strVersions(UBound(strVersions)), "CA") Then
			GetLatestMsgSetRequest = SessionManager.CreateMsgSetRequest("CA", 2, 0)
