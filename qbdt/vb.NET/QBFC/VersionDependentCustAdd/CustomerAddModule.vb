...
Errs: 
	...
	Private Function ProcessResponse(ByRef msgSetResponse As QBFC15Lib.IMsgSetResponse) As Boolean
		...
		If (msgSetResponse Is Nothing) Then
			'UPGRADE_WARNING: Couldn't resolve default property of object ProcessRequest. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
