...
ErrHandler: 
	...
	Private Function GetDates() As Object
		...
		If fromDate <> "" And Not IsDate(fromDate) Then
			...
			'UPGRADE_WARNING: Couldn't resolve default property of object GetDates. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			GetDates = False
			Exit Function
		End If
...
ErrHandler: 
	...
	Private Function QueryInvoices() As Object
		...
		If (response.StatusCode >= 1000) Then
			...
			End If
			'UPGRADE_WARNING: Couldn't resolve default property of object QueryInvoices. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			QueryInvoices = False
			Exit Function
		Else
...
ErrHandler: 
	...
	Private Sub ShowInvoices()
		...
		'UPGRADE_NOTE: Object invoiceCollection may not be destroyed until it is garbage collected. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
	...
	Private Function GetInvoiceRetDetail(ByRef invRet As QBFC15Lib.IInvoiceRet) As String
		...
		If (Not (orInvoiceLineRetList Is Nothing)) Then
			...
			'UPGRADE_WARNING: Couldn't resolve default property of object linendxMax. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			linendxMax = orInvoiceLineRetList.Count - 1
			'UPGRADE_WARNING: Couldn't resolve default property of object linendxMax. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			For linendx = 0 To linendxMax
				'UPGRADE_WARNING: Couldn't resolve default property of object linendx. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
