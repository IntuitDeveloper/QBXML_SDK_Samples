This sample is a simple VB.NET desktop application that is used for ItemInventoryMod by using QBFC2 COM dll. 

Running the sample
------------------

Before running ItemInventoryMod.exe, make sure that .NET runtime is installed on the machine, 
